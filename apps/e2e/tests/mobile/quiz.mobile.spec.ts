...
test.describe('/quiz/keycap-set — mobile (375px) — phase 47', () => {
  test('no horizontal scroll on keycap-set quiz page', async ({ page }) => {
    ...
    expect(
      overflow,
      `/quiz/keycap-set should not scroll horizontally at 375px (overflow=${overflow}px)`,
