...
lede: "Keychron's quiet takeover gets the trends treatment, DCS Dolch lands at Divinikey, and the tracker shows hall effect and split ergo both breaking into new territory."
issue: 2
...
**[DCS Dolch opens at Divinikey — a computing-history colorway returns](/article/divinikey-dcs-dolch-group-buy)**

Signature Plastics' DCS profile in the Dolch colorway is back on a group buy, pricing tiers unlocking as final quantities lock in. The piece covers what makes Dolch worth a second look beyond nostalgia, and where it sits next to the current glut of GMK CYL runs competing for the same shelf space.
