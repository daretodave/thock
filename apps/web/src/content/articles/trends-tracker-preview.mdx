...
This explainer covers the categories the tracker watches, the columns on every row, and — just as importantly — the things the tracker is not trying to be. <Source href="https://thock.netlify.app/trends/tracker">The live tracker</Source> updates each Friday at 08:00 UTC, with the previous week archived under its ISO week label.
