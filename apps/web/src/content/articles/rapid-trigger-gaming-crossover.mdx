...
The Trends Tracker has been logging this convergence. Hall Effect / Rapid Trigger has posted a score of 76 in W25 — up from 65 in W21 — the highest in the switch category for three consecutive weeks and treated as baseline expectation for new gaming boards across multiple W25 roundups.
...
The [Trends Tracker](/trends/tracker) continues logging both signals weekly.
