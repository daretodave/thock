...
lede: "Codex Micro, OpenAI's first piece of branded hardware, is a macro pad built by boutique vendor Work Louder on the bones of its $199 Creator Micro 2. It launched July 15, 2026 at $230, sold out within 24 hours, and now resells for $700-800+."
author: thock
pillar: news
...
<Callout type="info" title="Update — Codex Micro shipped">
  Codex Micro launched on schedule July 15, 2026, priced at $230 per TechCrunch and Engadget coverage of OpenAI's first hardware release. The tracker row held its climb through launch week, closing at a score of 96 — up from the 94 logged heading into launch.
</Callout>

<Callout type="note" title="Update — sold out, resale premium">
  Codex Micro sold out in under 24 hours. eBay resale hit $700-800+ per Resell Calendar and eWeek — more than three times its $230 retail price — despite mixed developer reviews of the unit itself. The tracker score climbed to 97, the highest of any row in the current snapshot.
</Callout>

The row to watch is the one already on the board: follow the [Trends Tracker](/trends/tracker) for the weekly read, and the [W31 snapshot](/trends/tracker/2026-W31) for the sellout and resale numbers.
