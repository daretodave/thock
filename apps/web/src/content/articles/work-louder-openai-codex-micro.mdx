...
The row to watch is the one already on the board: follow the [Trends Tracker](/trends/tracker) for the weekly read, and the [W30 snapshot](/trends/tracker/2026-W30) for the confirmed launch numbers.
