...
<Callout type="note" title="Update — sold out, resale premium">
  Codex Micro sold out in under 24 hours. eBay resale hit $700-800+ per Resell Calendar and eWeek — more than three times its $230 retail price — despite mixed developer reviews of the unit itself. The tracker score climbed to 97, the highest of any row in W31's snapshot.
</Callout>
