...
Builders working out whether their board needs lubing at all — what the mod changes at a board level, when the effort earns its keep, and what the minimum protocol looks like — can find that decision framework in [Lubing 101](/article/lubing-101). Builders wanting to understand why a lubed build evaluates better over a workday than over a typing benchmark will find that argument in [why typing tests lie](/article/typing-tests-lie).
