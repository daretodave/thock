...
updatedAt: '2026-06-05T23:30:00.000Z'
...
The Gazzew Boba family offers a useful comparison point here. The Boba U4T (mentioned above as a popular tactile) is the full-sound version; the <PartReference id="boba-u4" /> is its silent sibling — the same rounded, pronounced bump, with foam dampeners added top and bottom. The difference in sound between the two is considerable; the difference in feel is smaller than most builders expect.
