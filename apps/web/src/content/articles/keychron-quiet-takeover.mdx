...
description: "How Keychron's product ladder, firmware strategy, and community effect drove a 25-point brand momentum climb on the thock trends tracker in mid-2026."
...
The tracker reading was useful as a floor, not a ceiling. A brand score of 55 and rising, as of that W25 reading in a prebuilt-heavy news week, reflected the Q Ultra coverage, the ZMK firmware story, and the continuing stream of first-keyboard recommendations. Whether it would sustain above 55 through Q3 2026 depended on whether the Q Ultra's configurator story — specifically, whether Keychron's <Mono>ZMK</Mono> fork shipped a workflow that existing Q-line owners recognized as a sibling of <Mono>VIA</Mono> rather than a relearning exercise — landed well in reviews.
...
<Callout type="note" title="Update — the score kept climbing, well past 55">
  Per the [2026-W31 Trends Tracker](/trends/tracker/2026-W31), the Keychron brand score has climbed to 94, most recently driven by the V6 Ultra HE Kickstarter launch — covered in [Nova Socket: Keychron's bet on not choosing a switch technology](/article/keychron-nova-socket-hybrid). The "whether it sustains above 55" question this piece posed has a clear answer: it didn't just sustain, it kept climbing.
</Callout>
