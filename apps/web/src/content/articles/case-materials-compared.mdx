...
Real boards that land squarely in this character: the <Source href="https://drop.com/buy/drop-ctrl-mechanical-keyboard">Drop CTRL</Source> at the accessible end, the Mode Sonnet at the boutique end. Both are aluminium-bodied; both demonstrate the damped, controlled acoustic signature the material is known for.
...
The acoustic profile is the reason PC has found a home in budget-to-mid builds rather than being purely a bargain material. The ikki68 Aurora <Source href="https://wuquestudio.com/products/ikki68-aurora-r2">from Wuque Studio</Source> is the canonical example: a polycarbonate case that reads acoustically brighter and airier than most aluminium boards at similar or lower price points. The board became a reference point for "what PC sounds like" because Wuque executed the geometry well enough that the material's natural resonance character came through clearly. A PC 65% typically runs around 0.7 kg — meaningfully lighter than its aluminium equivalent.
