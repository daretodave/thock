...
description: "The beam-interrupt mechanism eliminates contact bounce entirely — what that means for actuation, latency, and the firmware pipeline behind rapid trigger."
