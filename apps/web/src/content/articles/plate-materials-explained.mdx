...
Polycarbonate plate plus gasket-mount plus a thock-forward switch (<PartReference id="oil-king" />, MMD Princess, anything heavy and long-poled) is the "deep thock" default. It is the sound the boutique 65% category sells, and it is the right answer for most builders chasing that soft, rounded low end.
