...
<InlineViz
  src="/article-viz/cannonkeys-blaine-v2-se-group-buy/mount-menu.svg"
  alt="Three mount-hardware cards side by side: top mount with a mini cross-section showing screws direct to the case, labeled 'firmer, more direct'; single-sided gasket in the center, coral-filled, with a mini cross-section showing gasket pads on the top row only, labeled 'compliant top, rigid bottom, PCB floats'; o-ring on the right with a mini cross-section showing a continuous dampening ring and no screws, labeled 'softest, most cushioned'. A feel-spectrum arrow runs beneath from 'top mount — firmer' to 'o-ring — softer'."
  caption="One purchase, three builds — the mount hardware you choose at build time decides the feel."
  accent="coral"
/>
...
<InlineViz
  src="/article-viz/cannonkeys-blaine-v2-se-group-buy/plate-material.svg"
  alt="Horizontal spectrum with FR4 anchored on the left ('softer, quieter') and aluminum anchored on the right ('stiffer, brighter'). A coral callout above the midpoint, connected by dashed brackets to both anchors, labels carbon fiber as 'stiffer than FR4 by a meaningful margin, lighter than aluminum' with a note that it 'doesn't map cleanly onto the aluminum-vs-FR4 spectrum'."
  caption="Carbon fiber doesn't sit cleanly between the two materials buyers already know."
  accent="coral"
/>
