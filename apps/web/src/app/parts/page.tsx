        ...
        >
          {sections.map((s) => (
            <Link
              ...
              className="group py-8 flex flex-col gap-3 rounded-sm hover:bg-surface-1 -mx-4 px-4 sm:-mx-6 sm:px-6 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-mu"
            >
