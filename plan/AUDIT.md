...
### [needs-scoping] [content] [3.5] rapid-trigger-gaming-crossover.mdx W21/W22 hall-effect score citation is entangled with its own sparkline SVG's conflicting week label
- category: content
- filed: 2026-07-14 by cloud /iterate audit (fresh general-purpose sweep)
...
- score: 3.5 (impact × ease / 10)
- action: before shipping, decide (a) whether "W21" in prose should become "W22" (matching the SVG's own coral-highlighted axis label), and/or (b) whether the cited score should move from 65 toward the real W21 file value of 55 — then update prose (3 spots: apps/web/src/content/articles/rapid-trigger-gaming-crossover.mdx lines ~56, ~60 alt text, ~65), the SVG's inflection-marker text/position (apps/web/public/article-viz/rapid-trigger-gaming-crossover/he-rt-score-sparkline.svg lines 40-43, 70, 77), and the provenance JSON together, matching the `d5f9e36` precedent for InlineViz corrections
