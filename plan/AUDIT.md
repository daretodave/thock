...
### [ ] [content] [4.2] 9 dead `<Source>` citations across 8 articles — vendor blog reorgs, dead product pages, changed YouTube handle
- category: content
- filed: 2026-07-05 by cloud /iterate audit
...
- score: 4.2 (impact × ease / 10)
- articles: `hmx-cloud-deep-dive.mdx:44` (hmxkeyboard.com — DNS fail), `gmk-cyl-ramune-group-buy.mdx:81` (geonworks.com — DNS fail), `gmk-cyl-pandemonium-group-buy.mdx:92` (bowlkeyboards.co.uk — DNS fail), `gsk-sweet-nightmare-group-buy.mdx:63` (kbdfans.com/products/sweet-nightmare — 404, correct slug is `gsk-sweet-nightmare` per sibling data record — trivial fix), `plate-materials-explained.mdx:56,58` (thockking.com/blogs/learn/plate-materials + theremingoat.com/blog/category/scientific+studies — both 404), `clicky-switches-deep-dive.mdx:84` + `cherry-mx2a-revision.mdx:51` (cherry-world.com/cherry-mx-2a — redirects to a malformed 404 URL), `switch-films-worth-it.mdx:30` (novelkeys.com/collections/switch-films — 404), `gasket-mount-reality.mdx:71` (youtube.com/@thereminGoat — 404, handle likely changed)
- next: fix the trivial `gsk-sweet-nightmare-group-buy.mdx:63` slug typo first (no research needed); spawn `scout` per remaining vendor/creator to find a live replacement URL (vendor homepage or current blog path) for the other 8
