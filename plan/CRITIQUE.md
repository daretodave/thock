...
### [x] [MED] / — every "By pillar" home tile dated 2026-05-10 (bulk-publish artifact reads as fake editorial cadence) — addressed in pending commit (this tick — cloud /iterate drain)
- issue: #78
- pass: 9 (commit 40b2e55)
- viewport: desktop
- category: content-gap
...
- fix: restamped the four non-exempt 2026-05-10 articles that drove the trends and guides pillar leaders onto 5/10. Specifically: `75-percent-default` (trends) 2026-05-10T16:00 → 2026-04-24T16:00; `split-ergo-cohort` (trends) 2026-05-10T17:00 → 2026-05-02T17:00; `vendor-first-customs` (trends) 2026-05-10T20:00 → 2026-05-04T20:00; `lubing-101` (guides) 2026-05-10T09:30 → 2026-04-30T13:30. The four other non-exempt 2026-05-10 articles (`keychron-q-ultra-zmk`, `typing-tests-lie`, `hmx-cloud-deep-dive`, `cherry-mx2a-revision`) stayed put because they are NOT their pillar's by-pillar leader (typing-tests-lie/ideas → spring-swaps-explained 5/11 is leader; hmx-cloud / cherry-mx2a / deep-dives → drop-holy-panda-x 5/12 is leader; keychron-q-ultra-zmk / news → group-buy-exempt prussian-alert 5/10 sits later anyway). The two group-buy companion articles (`gmk-cyl-prussian-alert`, `gmk-cyl-ishtar-r2-group-buy`) stay pinned per Rule 4 exemption. Post-restamp home rail: news 5/10 (keychron), trends 5/08 (trends-tracker-preview becomes leader), ideas 5/11 (spring-swaps-explained), deep-dives 5/12 (drop-holy-panda-x), guides 5/03 (keycap-profiles-compared becomes leader) — 5 distinct days. None of the four restamped articles contain "today"/"yesterday"/"this week" prose anchors that would now misread. No test changes needed: `manifest.generated.json` + `search/index.generated.json` regenerate via the existing prebuild step, and no test hardcodes these specific publishedAt values.
- source: browser
